...
class LiveStreamingHelper {
    ...
    private lateinit var senderWebRtcView: VideoTextureViewRenderer
    ...
    fun start(context : Context, senderSurfaceView : SurfaceViewRenderer?, receiverSurfaceView : SurfaceViewRenderer?,webRtsSenderView: VideoTextureViewRenderer){
    ...
    private fun initializeSenderWebrtcSurfaceView(surfaceView : VideoTextureViewRenderer) {
        this.senderWebRtcView = surfaceView
